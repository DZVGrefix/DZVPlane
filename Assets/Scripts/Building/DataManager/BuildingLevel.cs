...
public class BuildingLevel
{
    ...
    public bool isRepairBuilding;               // újra építhetőség miatt
    public Vector3 startPlane;                  // -22 17 0
    public Vector3 stopPlane;                   // 22 17 0
    public Vector3 finishPlane;                 // (numberOfBuilding / 2) + 1, 0 , 0

    public BuildingLevel(int level, int numberOfBuilding, int minHeight, int maxHeight, bool isRepairBuilding, Vector3 startPlane, Vector3 stopPlane, Vector3 finishPlane)
    {
        this.level = level;
        this.numberOfBuilding = numberOfBuilding;
        this.minHeight = minHeight;
        this.maxHeight = maxHeight;
        this.isRepairBuilding = isRepairBuilding;
